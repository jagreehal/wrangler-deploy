export const outputSchemas = {
  ...
  auth: {
    ...
    properties: {
      ...
      wranglerWhoami: { type: ["string", "null"] },
      accessProbe: { type: ["object", "null"] },
  ...
  bootstrap: {
    ...
    properties: {
      ...
      stage: { type: "string" },
      profile: { type: "string" },
      profileConfigured: { type: "boolean" },
      tokenPresent: { type: "boolean" },
      contextUpdated: { type: "object" },
      dryRun: { type: "boolean" },
      writes: { type: "array", items: { type: "string" } },
      next: { type: "array", items: { type: "string" } },
    },
    required: ["ok", "stage", "profile", "profileConfigured", "tokenPresent", "dryRun", "writes", "next"],
  },
  preflight: {
    type: "object",
    properties: {
